(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            const thumbsSwiper = new core(".hero__slider-thumb", {
                modules: [ Thumb, Pagination, Navigation, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                speed: 1800,
            ...
            new core(".hero__slider", {
                modules: [ Navigation, Thumb, EffectFade, Pagination, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 2.75,
                spaceBetween: 20,
